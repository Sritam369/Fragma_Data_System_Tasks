...
public class DatabaseClientRegistrationRepository implements ClientRegistrationRepository, Iterable<ClientRegistration> {
    ...
    private ClientRegistration createRegistration(OAuthProvider provider) {
        ...
        ClientRegistration.Builder builder = ClientRegistration.withRegistrationId(provider.getProviderId());
    ...
    public ClientRegistration findByRegistrationId(String registrationId) {
        ...
        return registrations.stream().filter(registration -> registration.getRegistrationId().equals(registrationId))
                .findFirst()
                .orElse(null);
    }
